...
exports.absolute = function absolute (requirePath, resolvedPath) {
  ...
  var moduleName = exports.getModuleName(resolvedPath);
...
exports.rebase = function rebase(moduleName, resolvedPath, context) {
  ...
  if (context.edited.loaded[moduleName]) {
    ...
    var validPathStartIndex = resolvedPath.indexOf(searchedString) + searchedString.length;
    var validPathSection    = resolvedPath.substring(validPathStartIndex);
